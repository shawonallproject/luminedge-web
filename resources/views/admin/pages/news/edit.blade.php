...
@section('content')
    <div class="card">
        <div class="card-body">
        <form action="{{URL::to('admin/news/update/'.$news->id)}}" method="post" id="news-form" enctype= multipart/form-data>
                @csrf
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="title">Title</label>
                        <input type="text" class="form-control" id="title" name="title"
                               placeholder="Enter Job title" value="{{$news->title}}" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="author">Author</label>
                        <input type="text" class="form-control" id="author" name="author"
                               placeholder="Enter Author" value="{{$news->author}}" required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <img id="output" style="max-height:200px" src="{{$news->image}}"/>
                    </div>
                </div>

                <div class="checkbox">
                    <input id="checkbox1" type="checkbox" name="activeBanner" @if($news->banner) checked @endif>
                    <label for="checkbox1">Active as banner<span>(*Please maintain ratio 1894 * 916 pixel)</span></label>
                </div>

                <div class="form-row" id="banner-row"  style={{$news->banner ? "display:block;":"display:none;"}}>
                    <div class="form-group col-md-6">
                        <div class="custom-file">
                    ...
                    <div class="form-group col-md-6">
                        <img id="banner-output" style="max-height:200px" src="{{$news->bannerImage}}"/>
                    </div>
                </div>
